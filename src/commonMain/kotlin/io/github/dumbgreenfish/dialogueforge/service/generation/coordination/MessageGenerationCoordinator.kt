...
import io.github.dumbgreenfish.dialogueforge.service.generation.api.GenerationController
...
import io.github.dumbgreenfish.dialogueforge.service.generation.execution.GenerationTask
...
class MessageGenerationCoordinator(
    ...
    private val emptyPartialResponses = MutableStateFlow<Map<String, String>>(emptyMap())
    override val partialResponses: StateFlow<Map<String, String>> = emptyPartialResponses.asStateFlow()
