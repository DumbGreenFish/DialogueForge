...
@Composable
private fun CustomMarkdownListItems(
    content: String,
    node: ASTNode,
    depth: Int = 0,
...
@Composable
private fun CustomMarkdownListItem(
    content: String,
    child: ASTNode,
    node: ASTNode,
    index: Int,
...
@Composable
private fun CustomMarkdownNestedListItem(
    nestedChild: ASTNode,
    content: String,
    depth: Int,
    markdownComponents: MarkdownComponents,
...
@Composable
private fun CustomMarkdownOrderedList(
    content: String,
    node: ASTNode,
    ...
    CustomMarkdownListItems(content, node, depth, markerModifier, listModifier) { index, listNumber, child ->
        BasicText(
...
@Composable
private fun CustomMarkdownBulletList(
    content: String,
    node: ASTNode,
...
private val MarkdownComponentModel.listDepth: Int
    get() = (extra[MARKDOWN_LIST_DEPTH_KEY] as? Int) ?: 0

@Composable
internal fun CustomOrderedListComponent(model: MarkdownComponentModel) {
    CustomMarkdownOrderedList(
...
@Composable
internal fun CustomBulletListComponent(model: MarkdownComponentModel) {
