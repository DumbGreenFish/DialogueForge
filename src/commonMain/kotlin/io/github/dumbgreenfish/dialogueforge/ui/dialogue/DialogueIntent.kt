...
sealed class DialogueIntent {
    ...
    data object AcceptBackgroundSetup : DialogueIntent()
    data object DeclineBackgroundSetup : DialogueIntent()
    data object OpenBackgroundSettings : DialogueIntent()
    data object ContinueWithoutBackgroundSettings : DialogueIntent()
    ...
    data class CopyMessage(val messageId: String) : DialogueIntent()
